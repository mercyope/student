...
import FetchData from './Component/Counter'
...
function App(){
//   const [data, setData]= useState("Mercy");
//   const [loading, setLoading] = useState();
 ...
 const handleEmail = (e) => {
  setEmail(e.target.value)      //  updating the useremail
  ...
  return(
    <div>
      ...
      {/* <form onSubmit={handleSubmit}> 
       ...
       <input className="form-control mt-2"  onChange={handleUser} value={username}  placeholder="username"/>
       <input className="form-control mt-2"  onChange={handleEmail} value={email}  placeholder="email"/>
       <input className="form-control mt-2" placeholder="age"  onChange={handleAge} value={age}  />
